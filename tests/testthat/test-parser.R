...
test_that("df2vw correctly parses data", {
    ...
    test_df = data.frame(
        ...
        text_v4 = rep(" Et harum| (quid)em: rerum facilis!", 4),
    ...
    ref_df = data.frame(
        features = c(" |NS1 num_v1:5e-05 fact_v2^a |NS2 fact_v2^a Et harum_ _quid_em_ rerum facilis! |NS3  Et harum| (quid)em: rerum facilis!",
                     " |NS1 num_v1:0.333333334 fact_v2^a |NS2 fact_v2^a Et harum_ _quid_em_ rerum facilis! |NS3  Et harum| (quid)em: rerum facilis!",
                     " |NS1 num_v1:10 fact_v2^b |NS2 fact_v2^b Et harum_ _quid_em_ rerum facilis! |NS3  Et harum| (quid)em: rerum facilis!",
                     " |NS1 num_v1:100000.314 fact_v2^c |NS2 fact_v2^c Et harum_ _quid_em_ rerum facilis! |NS3  Et harum| (quid)em: rerum facilis!"),
