...
if (!require("mltools", quietly = TRUE)) install.packages("mltools", repos = "http://cran.us.r-project.org")
...
if (!require("magrittr", quietly = TRUE)) install.packages("magrittr", repos = "http://cran.us.r-project.org") 
